...
using namespace std;
/**
 * @brief A classe Plotter permite a criação de desenhos.
 */
...
public:
    /**
     * @brief Plotter especifica um Widget para ser colocado no layout.
     * @param parent é um ponteiro que aponta pra um valor nulo e faz com que não seja preciso um pai específico para o Widget.
     */
    explicit Plotter(QWidget *parent = nullptr);
         /**
         * @brief paintEvent é um evento que desenha o grid por meio de uma matriz de cubos.
         */
        void paintEvent(QPaintEvent *event);
        /**
         * @brief mousePressEvent é um evento que desenha o voxel quando o mouse é clicado.
         */
         ...
         * @param _shape guarda a forma geometrica que será desenhada.
         */
        void shape(int _shape);
    ...
    public slots:
        ...
        /**
         * @brief changeRadius é a função resposável pelo tamanho do raio.
         * @param raio armazena o valor do raio da Esfera.
         */
        void changeRadius(int _radius);
        /**
        ...
        /**
         * @brief changePlane é a função responsável por alterar qual parcela do plano o usuário está visualizando.
         * @param pln armazena o valor do plano que o usuário escolheu.
         */
        void changePlane(int _plane);
        /**
         * @brief createOff é a função responsável por chamar writeOFF(), que salva o arquivo no formato OFF.
         */
        void createOff();
        /**
